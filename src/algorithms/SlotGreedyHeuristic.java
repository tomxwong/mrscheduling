...
public class SlotGreedyHeuristic implements Method {
	...
	public SlotGreedyHeuristic(Schedule s, String rule){
		this.schedule = s;
		this.rule = rule;
...
//ArrayList<Integer> list = task.getHostList();
	...
	public static void main(String[] args) {
		...
		try {
			...
			SlotGreedyHeuristic gh1 = new SlotGreedyHeuristic(s2, "JR");
			gh1.init();
			gh1.start();
			gh1.output();
