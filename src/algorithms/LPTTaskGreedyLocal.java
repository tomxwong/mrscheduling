...
public class LPTTaskGreedyLocal implements Method {

	private Schedule schedule;
	private Comparator slotCompare;
	private String rule;
	
	public LPTTaskGreedyLocal(Schedule s, String rule){
		this.schedule = s;
		this.rule = rule;
	...
	@Override
	public void output() {
		System.out.println("The makespan of the schedule under LPT task greedy heuristic Local method is: " + schedule.getMakespan());
